...
- **[implement](./skills/engineering/implement/SKILL.md)**: Build the work described by a spec or set of tickets in its own worktree and branch, driving `/tdd` at pre-agreed seams and closing out with `/code-review` before committing.
